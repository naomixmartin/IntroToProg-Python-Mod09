...
# RRoot,1.1.2030,Created script in Listing07
# naomimartin, 09.02.2022, modified script to complete the Processing Classes module
# ---------------------------------------------------------- #
...
class FileProcessor:
    ...
    methods:
        save_data_to_file(file_name,list_of_objects): writes string data from list_of_objects to file_name
        read_data_from_file(file_name): reads data from file_name -> (a list of objects)
